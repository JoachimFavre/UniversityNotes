...
\parag{Syntactical rule}{
    VHDL is a case-insentive langue. Also, it has free formatting (we can indent the code how we want). Each command sequence is terminated by a semicolon. We can make a line comment using a double dash: \texttt{-{}-}.
}
