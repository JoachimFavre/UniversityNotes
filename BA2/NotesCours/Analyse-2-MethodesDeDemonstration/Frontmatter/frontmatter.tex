...
\begin{parag}{Théorème du min et du max sur un compact}
    ...
    \begin{subparag}{Preuve $f\left(E\right)$ est borné}
        ...
        Supposons par l'absurde que $f\left(E\right)$ n'est pas borné, c'est à dire que pour tout $k \geq 0$, il existe un $\bvec{x}_k \in E$ tel que $\left|f\left(\bvec{x}_k\right)\right| \geq k$. Ceci nous donne une suite $\left\{\bvec{x}_k\right\} \in E$.
        ...
        Mais, par construction, $\left|f\left(\bvec{x}_k\right)\right| \geq k$ pour tout $k \in \mathbb{N}$, ce qui est notre contradiction. Nous en concluons que $f$ est bornée sur $E$.
    \end{subparag}
