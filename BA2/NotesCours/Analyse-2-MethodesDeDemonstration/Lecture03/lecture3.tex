...
\parag{Exemple 1}{
    ...
    \subparag{Preuve}{
        ...
        En fait, cette dernière phrase est fausse, on pourrait avoir $ab = 4\cdot 9$ avec $a = 2$ et $b = 18$. En fait, l'affirmation que nus voulions montrer est uniquement vraie pour $\impliedby$. On peut par exemple trouver le contre-exemple $a = 3$ et $b = 8$.
    }
