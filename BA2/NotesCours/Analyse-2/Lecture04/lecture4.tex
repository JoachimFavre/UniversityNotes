...
\parag{EDL2 homogène}{
    ...
    \begin{enumerate}
        \item La solution générale d'une EDL2 homogène à coefficients constants contient 2 constantes arbitraires. En fait, c'est le cas pour les EDL2 homogènes en générale. Ce point est difficile à démontrer, et nous ne le feront pas dans ce cours.
