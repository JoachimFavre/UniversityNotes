...
\subsection{Minimum et maximum d'une fonction continue sur un compact}
...
\parag{Exemple 2}{
    ...
    Cependant, si $b = 0$, nous avons deux solutions pour chaque $x$ dans tout voisinage de $b$. Par exemple, en considérant un voisinage de $\left(-1, 0\right)$, nous pouvons voir que tout $x$ aurait besoin de deux valeurs:
