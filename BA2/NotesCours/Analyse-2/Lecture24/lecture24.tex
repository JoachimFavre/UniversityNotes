...
\parag{Exemple}{
    ...
    Notez qu'il est absolument nécessaire d'intégrer selon $x$ en premier (comme mentionné ci-dessus, $e^{x^3}$ n'a pas de primitive exprimée en fonctions élémentaires). Cependant, nous pouvons échanger l'ordre d'intégration entre $y$ et $z$: 
...
\parag{Exemple 1}{
    ...
    Ainsi, nous trouvons que notre fonction de changement de variable est donné par: 
...
\parag{Application: Changement de variables polaire}{
    ...
    Calculons son déterminant Jacobiens: 
