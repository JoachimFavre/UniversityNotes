...
\parag{Exemple 3}{
    ...
    \subparag{Dérivées partielles secondes}{
        ...
        Par la contraposée du théorème de Schwartz, nous savons que $\frac{\partial^2 f}{\partial x \partial y}$ n'est pas continue en $\left(0, 0\right)$. En effet, pour $\left(x, y\right) \neq \left(0, 0\right)$: 
        \[\frac{\partial^2 f}{\partial x \partial y} = \frac{6x^2 y^4 + y^6 - 3x^4 y^2}{\left(x^2 + y^2\right)^3} = \frac{\partial^2}{\partial y \partial x}\]
