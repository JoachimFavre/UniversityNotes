...
\parag{Exemple: Coordonnées polaires}{
...
\parag{Exemple}{
    ...
    \subparag{Directement}{
        ...
        =\ & \frac{\pi}{2y}\sin\left(\frac{\pi y}{2}\right) + \frac{1}{y^2}\left(\cos\left(\frac{\pi y}{2} - 1\right)\right) 
        \end{multiequality}
        comme attendu.
...
\parag{Théorème}{
    ...
    \subparag{Preuve}{
        ...
        \[A'\left(t\right) = \underbrace{f\left(g\left(t\right), t\right)}_{\frac{\partial F}{\partial g}}g'\left(t\right) - \underbrace{f\left(h\left(t\right), t\right)}_{\frac{\partial F}{\partial h}}h'\left(t\right) + \int_{h\left(t\right)}^{g\left(t\right)} \frac{\partial f}{\partial t}\left(x, t\right)dt\]
    ...
    \subparag{Note personnelle: Intuition}{
        ...
        \[F\left(x, t\right) = \int f\left(x, t\right)dx \implies A\left(t\right) = F\left(g\left(t\right), t\right) - F\left(h\left(t\right), t\right)\]
