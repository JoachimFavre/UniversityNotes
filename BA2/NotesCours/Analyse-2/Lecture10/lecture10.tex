...
\parag{Théorème des 2 gendarmes}{
    ...
    \begin{enumerate}
        \item $\displaystyle \lim_{\bvec{x} \to \bvec{x_0}} f\left(\bvec{x}\right) = \lim_{\bvec{x} \to \bvec{x_0}} g\left(\bvec{x}\right) = \ell$
...
\parag{Théorème du min et du max sur un compact}{
    ...
    \subparag{Preuve $f\left(E\right)$ est borné}{
        ...
        Mais, par construction, $\left|f\left(\bvec{x_k}\right)\right| \geq k$ pour tout $k \in \mathbb{N}$, donc $\left\{f\left(\bvec{x_{k_p}}\right)\right\}$ n'est pas bornée et ne peut donc pas converger. Ceci est notre contradiction, nous en concluons que $f$ est bornée sur $E$.
    }
