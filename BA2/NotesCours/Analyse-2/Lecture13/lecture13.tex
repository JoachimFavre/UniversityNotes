...
\begin{itemize}[left=0pt]
    ...
    \item Explication du théorème de Schwartz.
...
\parag{Exemple}{
    ...
    Nous allons utiliser cet exemple afin d'illustrer le théorème de Schwartz, et les matrices Hessiennes.
...
\parag{Exemple 1}{
    ...
    \subparag{Dérivées partielles}{
        ...
        Si nous voulons trouver la dérivée partielle selon $y$, alors nous pouvons utiliser la symétrie de fonction et échanger les $x$ et les $y$ dans $\frac{\partial f}{\partial x}$: 
