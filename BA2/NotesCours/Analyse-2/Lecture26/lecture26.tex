...
\parag{Exemple}{
    Nous voulons calculer le volume d'une ellisoïde, c'est à dire: 
...
\parag{Exemple 1}{
    ...
    Il n'y a pas vraiment de ressemblance avec un cercle ou une sphère (il n'y a pas vraiment de carré), donc nous ne pouvons pas vraiment prendre de changement de variable sphérique ou cylindrique. 
...
\parag{Exemple 3}{
    ...
    \[I = \int_{0}^{\frac{\pi}{3}} \left(\int_{0}^{1} \frac{\sin\left(r^2\right)}{1 + e^3} r\right)\]
...
\parag{Exemple 6}{
    Nous nous demandons l'aire de quoi exprime l'intégrale suivante: 
    ...
    Nous trouvons donc que notre intégrale calcule l'aire d'un triangle.
}
