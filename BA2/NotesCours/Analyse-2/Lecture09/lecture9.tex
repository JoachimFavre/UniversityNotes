...
\parag{Exemple 1}{
    ...
    &\ z^2 = 1 - \left(x^2 + y^2\right) \iff x^2 + y^2 + z^2 = 1 \\
    &\ z \geq 0
...
\parag{Exemple 1}{
    ...
    Prenons la suite $\bvec{a_k} = \left(\frac{1}{k}, \frac{1}{k}\right)$, qui converge bien vers 0 quand $k \to \infty$. Alors: 
    \[\lim_{k \to \infty} f\left(\bvec{a_k}\right) = \lim_{k \to \infty} \frac{\frac{1}{k} \cdot \frac{1}{k}}{\left(\frac{1}{k}\right)^2 + \left(\frac{1}{k}\right)^2} = \frac{1}{2}\]
    
    Comme deuxième suite, prenons $\bvec{b_k} = \left(\frac{1}{k}, 0\right)$ qui tend bien vers $\left(0, 0\right)$ quand $k$ tend vers l'infini. Alors: 
    \[\lim_{k \to \infty} f\left(\bvec{b_k}\right) = \lim_{k \to \infty} \frac{\frac{1}{k} \cdot 0}{\frac{1}{k^2}} = \lim_{k \to \infty} 0 = 0\]
