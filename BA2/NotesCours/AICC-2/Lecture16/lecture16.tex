...
\parag{Example 2}{
    ...
    \[\left(\left[x_2\right]_{7}\right)^2 = \left[0\right]_7 \implies x_2 = \left[0\right]_7\]
...
\parag{Backward mapping}{
    We want to know how to get $\left[a\right]_{pq}$ when having $\left(\left[a\right]_p, \left[a\right]_q\right)$.
