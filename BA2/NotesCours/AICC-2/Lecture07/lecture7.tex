...
\parag{Theorem}{
    ...
    \subparag{Proof}{
        ...
        However, since entropy is nonnegative, we get that $H\left(S_n | S_1, \ldots, S_{n-1}\right)$ is bounded by $H\left(S_1\right)$ and 0 for all $n$, and thus that $\lim_{n \to \infty} H\left(S_n | S_1, \ldots, S_{n-1}\right)$ exists.
    }
...
\parag{Theorem}{
    ...
    \subparag{Proof}{
        ...
        Note that the quality $\dagger$ holds since the source is stationary, and the inequality * holds because conditioning reduces entropy.
...
\parag{Example: Coin-flip source}{
    ...
    Since the source produces independent and identically distributed symbols, we get: 
