...
\parag{Introduction}{
    After $\mathbb{Z} / m\mathbb{Z}$, wee could go into two directions. Focus on finite groups, which have one operations, or focus on finite fields, which have two operations. 
