...
\parag{Example}{
    ...
    $\Gamma_A$ is uniquely decodable as well, since we only read two characters every time. More generally, every fixed-length code is always uniquely decodable.
}
