...
\parag{Theorem}{
    ...
    \subparag{Proof}{
        Let $n = \left|E\right|$ be the number of edges. The idea is to encode each 3-edge $e\in E \subseteq U \times V \times W$ as a $3n$-bit number in base $b = n + 1$, using only 0s and 1s.
