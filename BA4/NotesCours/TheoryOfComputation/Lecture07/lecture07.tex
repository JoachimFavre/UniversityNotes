...
\parag{Definition: Polynomial time verifier}{
    A \important{polynomial time verifier} (poly-time verifier) is a verifier which running on any input $\left\langle x, C \right\rangle$ is polynomial in $\left|x\right|$.
