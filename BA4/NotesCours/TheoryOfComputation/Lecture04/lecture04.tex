...
\parag{Definition: TM configuration}{
    ...
    \[\begin{systemofequations} uq_j a c v, & \text{if } \delta\left(q_im b\right) = \left(q_j, c, L\right) \\ u a c q_j v, & \text{if } \delta\left(q_i, b\right) = \left(q_j, c, R\right) \end{systemofequations}\]
