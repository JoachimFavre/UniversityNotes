...
\parag{Corollaire: Règle de l'Hospital}{
    ...
    \subparag{Remarque}{
        Ce corollaire est facilement généralisable: si $f\left(z_0\right) = f'\left(z_0\right) = \ldots = f^{\left(n\right)}\left(z_0\right) = 0$ et $g\left(z_0\right) = g'\left(z_0\right) = \ldots = g^{\left(n\right)}\left(z_0\right) = 0$, alors:
