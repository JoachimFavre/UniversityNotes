...
\parag{Proposition: Caractérisation des pôles}{
    ...
    \subparag{Esquisse de preuve}{
        ...
        Ceci est donc équivalent au fait que $F\left(z\right)$ admet un développement en série de Taylor en $z_0$. Nous avions vu plutôt qu'une fonction est holomorphe si est seulement si elle admet une série de Taylor, donc $F$ est holomorphe. Pour être rigoureux, il faudrait montrer que $F$ est bien convergente.
...
\parag{Exemple}{
    ...
    \[f\left(z\right) = \frac{1}{z^2 - z^4\epsilon\left(z\right)}\]
