...
\parag{Theorem: Properties}{
    Let $\phi\left(z\right)$ be the PDF, $\Phi\left(z\right)$ be the CDF and $z_p$ be the equantiles of $Z \followsdistr \mathcal{N}\left(0, 1\right)$.
...
\parag{Example 2}{
    ...
    \[\prob\left(Y \leq y\right) = \prob\left(Y \leq y\right) = \prob\left(-y \leq Z \leq y \right) = \Phi\left(y\right) - \Phi\left(-y\right) \implies p_Y\left(y\right) = 2 \phi\left(y\right)\]
