...
\parag{Example}{
    A family has two children, giving the following sample space (the first letter represents the sex of the first child, ans similarly for the second): 
...
\parag{Simpson's paradox}{
    ...
    However, in fact, in both cases, the females have always better succeeded than the non-sportive ones. However, we still have $1 + 990\cdot 0.50 \approx 500$ males who passed and $990\cdot 0.2 + 10 \approx 200$ females. So, indeed, there were females who passed, but they were in fact better than the males.
