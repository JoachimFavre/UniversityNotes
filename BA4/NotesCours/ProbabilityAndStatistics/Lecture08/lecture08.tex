...
\parag{Theorem: Expectancy properties}{
...
\parag{Definition: Moments of a distribution}{
...
\parag{Definition: Variance and standard deviation}{
...
\parag{Theorem: Properties of variance}{
    ...
    \subparag{Intuition}{
        ...
        The third property just means that if there the average squared distance to the mean is 0, then the random variable must always give the mean.
    }
}
