...
\parag{Definition: Conditional probability}{
    ...
    \subparag{Intuition}{
        ...
        Since we know that $B$ happened, this is like if our new sample space $B$ and that we are looking for the event $A \cap B$.
    }
}

\parag{Example}{
    We roll two faire dice, one red and one green. Let $A$ and $B$ be the events that the total exceeds 8, and that we get 6 on the red die, respectively. We want to compute the probability of $A$ knowing that $B$ has occurred.
