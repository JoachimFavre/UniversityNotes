...
\parag{Théorème de Green}{
    ...
    \subparag{Preuve}{
        ...
        \begin{enumerate}
            \item Le cas d'un triangle. \later{fait la semaine prochaine}
            \item Le cas des triangles généraux.
            \item On considère un $\Omega$ général. Nous pouvons trianguler notre domaine, l'approximer avec des triangles infinitésimaux. L'intégrale sur la surface est à peu près égale à la somme des surfaces des triangles. Aussi, la somme des intégrales sur le bord donnent celle 
        \end{enumerate}
    }
}
