...
\parag{Définition: Courbe régulière par morceaux}{
    $\Gamma$ est une courbe régulière par morceaux si $\Gamma = \Gamma_1 \cup \ldots \cup \Gamma_k$, où les $\Gamma_i$ sont des courbes régulières.
...
\parag{Définition: Intégrale curviligne}{
    ...
    \subparag{Remarque 2}{
        L'intégrale $\int_{\Gamma} f d \ell $ ne dépend pas de la paramétrisation choisie.
    }
