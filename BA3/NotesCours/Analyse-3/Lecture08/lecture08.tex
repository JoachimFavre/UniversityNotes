...
\parag{Exemple 1}{
    ...
    \subparag{Intégrale en 2 dimensions}{
        ...
        \autoeq{\unexpanded{\iint_{\Sigma} \left(\rot F\right) \dotprod dS = \int_{0}^{1} \int_{0}^{2\pi} \left(1, 1, 1\right) \dotprod \left(-2\cos\left(\theta\right), -2\sin\left(\theta\right), z\right) d \theta dz = \int_{0}^{1} \int_{0}^{2\pi} \left(-2\cos\left(\theta\right) - 2\sin\left(\theta\right) + z\right) d \theta dz = \int_{0}^{1} 2\pi z dz = 2\pi \frac{1}{2} = \pi}}
    }
