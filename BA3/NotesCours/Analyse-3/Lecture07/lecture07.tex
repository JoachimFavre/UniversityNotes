...
\begin{parag}{Exemple 1}
    ...
    \begin{subparag}{Intégrale triple}
        ...
        \autoeq{\iiint_{\Omega} \Div F dxdydz = \int_{0}^{1} \int_{0}^{2\pi} \int_{0}^{1} 2r\cos\left(\theta\right) \cdot  \underbrace{r}_{\text{Jacobien}} dz d \theta dr = \int_{0}^{1} dz \int_{0}^{1} r^3 dr \underbrace{\int_{0}^{2\pi} 2\sin\left(\theta\right) d \theta}_{= 0} = 0}
