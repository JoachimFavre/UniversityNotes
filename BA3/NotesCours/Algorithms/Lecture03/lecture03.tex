...
\parag{Theorem: Correctness of Merge-Sort}{
...
\parag{Complexity analysis}{
    ...
    \autoeq{\unexpanded{T\left(n\right) = 2T\left(\frac{n}{2}\right) + c\cdot n = 2\left(2T\left(\frac{n}{4}\right) + c \frac{n}{2}\right) + c n = 4T\left(\frac{n}{4}\right) + 2cn = 4\left(2T\left(\frac{n}{8}\right) + c \frac{n}{4}\right) = 8T\left(\frac{n}{8}\right) + 3cn}}
    ...
    \subparag{Proof: Upper bound}{
        ...
        \begin{itemize}[left=0pt]
            ...
            \autoeq{\unexpanded{T\left(n\right) = 2T\left(\frac{n}{2}\right) + cn \over{\leq}{IH}  2 \frac{an}{2} \log\left(\frac{n}{2}\right) + cn = an \log\left(\frac{n}{2}\right) + cn = an\log\left(n\right) - an + cn \leq an\log\left(n\right)}}
    ...
    \subparag{Proof: Lower bound}{
        ...
        \begin{itemize}[left=0pt]
            ...
            \item We assume that our statement is true for all $k \in \left\{0, \ldots, k-1\right\}$ we want to prove it for $n = k$:
                \autoeq{\unexpanded{T\left(n\right) = 2T\left(\frac{n}{2}\right) + cn \over{\geq}{IH} 2 \frac{bn}{2} \log\left(\frac{n}{2}\right) + cn = bn \log\left(\frac{n}{2}\right) + cn = bn\log\left(n\right) - bn + cn \geq bn\log\left(n\right)}}
            selecting $b \leq c$.
    ...
    \subparag{Remark}{
        ...
        Note that we are allowed take the same $c$ everywhere since we are considering the worst-case, and thus we can take the maximum of the two constants supposed to be there, and call it $c$.
