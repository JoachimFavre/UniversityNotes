...
\parag{Disjoint-set data structures}{
...
\parag{Linked list representation}{
...
\parag{Application: Connected components}{
...
\parag{Definition: Spanning tree}{
...
\parag{Minimum spanning tree (MST)}{
    ...
    \subparag{Application: Communication networks}{
    ...
    \subparag{Application: Clustering}{
...
\parag{Definition: Crossing edge}{
