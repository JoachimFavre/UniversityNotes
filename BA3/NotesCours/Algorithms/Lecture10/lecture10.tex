...
\lecture{10}{2022-10-24}{''There are 3 types of mathematicians: the ones who can count, and the ones who cannot'' (Prof. Kapralov) (this title is never too long)}{
...
\parag{Dynamic programming}{
    ...
    \min_{i \leq k < j} \left\{m\left[i, j\right] + m\left[k+1, j\right] + p_{i-1} p_k p_j\right\}, \mathspace \text{if } i < j
    \end{functionbypart}
