...
\parag{Example}{
    ...
    \subparag{Personal note}{
        ...
        In forward mode, this means $\delta x = \frac{\partial x}{\partial a}$. We thus indeed know that $\delta a = \frac{\partial a}{\partial a} = 1$ are we looking for $\delta e = \frac{\partial e}{\partial a}$. Note that, in this case, we indeed have the following property (using first the inverse rule, then the chain rule): 
