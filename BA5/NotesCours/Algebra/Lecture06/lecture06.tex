...
\begin{parag}{Theorem: Sign invariance}
    ...
    \begin{subparag}{Proof idea}
        ...
        The only inversion that will change is the one of $\left(i, j\right)$ which will either stop being one or become one. Thus, the action by a transposition changes the number of inversions by an odd number.
    \end{subparag}
\end{parag}
