...
\begin{itemize}[left=0pt]
    ...
    \item Notez que le titre de ce cours essaie de faire une référence à Undertale (en \textit{run} génocide, quand on sauvegarde, il est juste écrit "Détermination.")
\end{itemize}
