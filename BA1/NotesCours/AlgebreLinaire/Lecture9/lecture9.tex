...
\parag{Théorème}{
    ...
    \subparag{Remarque}{
        Ce théorème est très pratique pour calculer un déterminant d'une matrice. On peut transformer notre matrice $A$ en matrice diagonale, puis il est très simple de retrouver le déterminant si on a pris notes de opérations qu'on a utilisée.
    }
}
