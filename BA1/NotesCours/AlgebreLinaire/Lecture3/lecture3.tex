...
\parag{Équation vectorielle}{
    ...
    \[c_1 \begin{bmatrix} -1 \\ 1 \end{bmatrix} + c_2 \begin{bmatrix} 2 \\ 1 \end{bmatrix} = \begin{bmatrix} 5 \\ 2 \end{bmatrix} \iff \begin{bmatrix} -c_1 \\ c_1 \end{bmatrix} + \begin{bmatrix} 2c_2 \\ c_2 \end{bmatrix} = \begin{bmatrix} -c_1 + 2c_2 \\ c_1 + c_2 \end{bmatrix} \]

    On se retrouve donc avec le système d'équation suivante
...
\parag{Observation}{
    ...
    \[\begin{bmatrix} 3 & -2 & 1 \\ 2 & 9 & 8 \end{bmatrix} \begin{bmatrix} x_1 \\ x_2 \\ x_3 \end{bmatrix} = A \bvec{x} = \begin{pmatrix} b_1 \\ b_2 \end{pmatrix} \]
...
\parag{Exemple}{
    ...
    On remarque que peut importe les opérations élémentaires qu'on applique sur la matrice augmentée, les zéros vont toujours rester dans lea dernière colonne. Pour notre système, on se rend compte qu'il est équivalent au système suivant:
    \begin{systemofequations}{}
    &\ x_1 = \frac{4}{3}x_3 \\
    &\ x_2 = 0 \\
    &\ 0 = 0
