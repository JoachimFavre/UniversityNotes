...
\parag{Truth tables for compound proposition}{
...
\parag{De Morgan's Laws}{
    ...
    \subparag{Proof of the first law}{
...
\parag{Applying logical equivalences}{
...
\parag{Constructing new logical equivalences}{
...
\parag{Complexity of DNF and CNF}{
...
\parag{Example of application of propositional logic}{
