...
\begin{parag}{Subject of the course}
    We will mostly speak about \important{discrete mathematics}, structures of which the number of elements is finite or can be enumerated. For example, natural numbers, graphs, formulas (since they have a finite number of symbols).
