...
\parag{Definition: Lattices}{
    A partially ordered set in which every pair of elements has booth a least upper bound and a greatest lower bound is called a lattice.
...
\parag{Definition: Lexicographic ordering}{
    ...
    \[a_1 \preccurlyeq b_1 \lor \left(a_1 = b_1 \land a_2 \preccurlyeq_2 b_2\right)\]
...
\parag{Set of finite strings}{
    The set of finite strings $s$ over a finite alphabet $A$ is countably infiniite.
