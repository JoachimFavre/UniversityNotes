...
\parag{Definition: Comparability}{
    The elements $a$ and $b$ of a poset $\left(S, \preccurlyeq\right)$ are \important{comparable} if either $a \preccurlyeq b$ or $a \preccurlyeq b$. When $a$ and $b$ are elements of $S$ so that neither $a \preccurlyeq b$ nor $a \preccurlyeq b$, then $a$ and $b$ are called \important{incomparable}.
...
\parag{Hasse diagrams}{
    We know that all relations are reflexive, transitive and anti-symmetric. 
