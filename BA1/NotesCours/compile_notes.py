...
# COURSES_NAME = ["AICC-1"]
# COURSES_NAME = ["AlgebreLinaire"]
# COURSES_NAME = ["Analyse-1"]
# COURSES_NAME = ["IntroProgrammation"]
# COURSES_NAME = ["PhyisqueGenerale"]
...
def _compile_course(course_name, tmp_dir):
    ...
    if compile_tex(tmp_dir) != 0:
        ...
        move_result(tmp_dir, course_name)

        if move_questions_if_any(tmp_dir, course_name):
            print("\tThere are hanging questions.")

        print("Done, the result is " + course_name + ".pdf.")
