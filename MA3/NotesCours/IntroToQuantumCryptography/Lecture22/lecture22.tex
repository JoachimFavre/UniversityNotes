...
\begin{parag}{Theorem}
    ...
    \begin{subparag}{Proof}
        ...
        \autoeq{\frac{1}{\left|\mathcal{K}\right|} \sum_{k \in \mathcal{K}} \left(\Enc_k \otimes I_E\right)\left(\rho_{ME}\right) = \frac{1}{2^{2n}} \sum_{k = \left(k_1, k_2\right)} \sum_{u, v} X^{k_1} Z^{k_2} X^u Z^v \left(X^{k_1} Z^{k_2}\right)^{\dagger} = \frac{1}{2^{2n}} \sum_{k} \sum_{u, v} \left(-1\right)^{u \dotprod k_2} \left(-1\right)^{v \dotprod k_1} X^{u} Z^v \otimes N_E^{\left(u, v\right)},}
