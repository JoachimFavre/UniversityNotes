...
\begin{parag}{Theorem: Impossibility of quantum bit commitment}
    ...
    \begin{subparag}{Proof}
        ...
        More formally, it can be shown that it gives us a bound on the fidelity: 
        ...
        But then, this means that using the fact $z + z^* = 2\cre\left(z\right)$ and that $\cre\left(z\right) \leq \left|z\right|$ for any $z \in \mathbb{C}$:
        \autoeq{\left\|U_A \otimes I_B \ket{\psi_0}_{AB} - \ket{\psi_1}_{AB}\right\|^2 = \left(\bra{\psi_0} U_a^{\dagger} - \bra{\psi_1}\right) \left(U_A \ket{\psi_0} - \ket{\psi_1}\right) = 2 - 2 \cre\left(\bra{\psi_1} U_A \ket{\psi_0}\right) \geq 2 - 2 \left|\bra{\psi_1} U_A \ket{\psi_0}\right| = \epsilon.}
