...
\begin{parag}{Theorem}
    ...
    \item \textit{(Decryption)} We describe decryption $\Dec_k\left(\sigma\right) = \Dec_G\left(\sigma\right)$. We measure the first $2n$ qubits to get $r$. We then evaluate $\left(u, v\right) \leftarrow G\left(r\right)$ and, leaving $\sigma_2$ to be the last $n$ qubits of $\sigma$, output: 
