...
\begin{parag}{Lemma}
    ...
    \begin{subparag}{Proof}
        ...
        It can easily be checked that $p_{UV}asdu, v$ is a valid probability distribution. This thus induces some random variable $V \followsdistr p_{V|U}$. This random variable is such that:
