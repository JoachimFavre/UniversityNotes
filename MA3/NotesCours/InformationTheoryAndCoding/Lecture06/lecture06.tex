...
\begin{parag}{Definition: set of $\epsilon$-typical sequences}
    ...
    \begin{subparag}{Remark 2}
        We may simplify the notation of $\left(1 - \epsilon\right) p_U\left(u\right) \leq \type_{u^n}\left(u\right) \leq \left(1 + \epsilon\right) p_U\left(u\right)$ by writing:
        \[\type_{u^n}\left(u\right) = \left(1 \pm \epsilon\right) p_U\left(u\right).\]
        
        We will have many similar inequalities, that may all be simplified similarly.
    \end{subparag}
