...
\begin{itemize}[left=0pt]
    ...
    \item Definition of the binary erasure channel.
\end{itemize}
...
\begin{parag}{Model}
    ...
    \begin{itemize}
        ...
        \item The transmission system is said to be \important{without feedback} if there isn't the dashed arrow on the diagram. In other words, if knowing $X^{i-1}$, then $X_i$ is independent:
...
\begin{parag}{Example 1: Binary erasure channel}
    Consider the following memoryless and stationary channel:
...
\begin{parag}{Example 2: Additive Gaussian channel}
