...
\begin{parag}{Example 2}
    ...
    \begin{itemize}
        ...
        \item Let us now assume that $D \geq \sigma^2$. We aim to show that $R\left(D\right) \leq 0$.
            ...
            \item Let us assume that $D \leq \sigma^2$ first. We aim to show that $R\left(D\right) \leq \frac{1}{2} \log_2\left(\frac{\sigma^2}{D}\right)$.
